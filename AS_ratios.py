...
bprop1 = dict(linewidth = 2, edgecolor = 'k', facecolor = 'red')
wprop1 = dict(linewidth = 2, linestyle = '-', color = 'k')
mprop1 = dict(linestyle = '-',linewidth = 2, color = 'k')
pprop1 = dict(marker = 'o', markeredgecolor = 'k', markerfacecolor = 'k')
...
bprop2 = dict(linewidth = 2, edgecolor = 'k', facecolor='pink')
...
bprop3 = dict(linewidth = 2, edgecolor = 'k', facecolor = 'green')
wprop3 = dict(linewidth = 2, linestyle = '-', color = 'k')
mprop3 = dict(linestyle = '-',linewidth = 2, color = 'k')
pprop3 = dict(marker = 'o', markeredgecolor = 'k', markerfacecolor = 'k')
cap3 = dict(linewidth = 2, color = 'k')
...
bprop4 = dict(linewidth = 2, edgecolor = 'k', facecolor = 'lightgreen')
wprop4= dict(linewidth = 2, linestyle = '-', color = 'k')
mprop4 = dict(linestyle = '-',linewidth = 2, color = 'k')
pprop4 = dict(marker = 'o', markeredgecolor = 'k', markerfacecolor = 'k')
cap4 = dict(linewidth = 2, color = 'k')
...
plt.ylim(0,1)
plt.yticks(np.arange(0,1.1,0.5), size = 22, **csfont)
plt.xlim(0,20)
...
# formateo ejes y ticks
plt.ylim(0.5,1)
plt.yticks(np.arange(0.5,1.01,0.5), size = 22, **csfont)
plt.xlim(0,1.2)

# agrego titles
#box1.text(0.7,1.03,r'Fecal/Phyto', fontsize = 18, **csfont)
box1.text(0.8,1.03,r'Cop/epiCop', fontsize = 22, **csfont)
box1.text(5.7,1.03,r'Cop/ethylCop', fontsize = 22, **csfont)
box1.text(11,1.03,r'Sito/ethylCop', fontsize = 22, **csfont)
box1.text(17,1.03,r'Chrol/Chnol', fontsize = 22, **csfont)
