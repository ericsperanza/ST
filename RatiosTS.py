...
bprop2 = dict(linewidth = 2, edgecolor = 'red', facecolor = 'lightpink')
wprop2 = dict(linewidth = 2, linestyle = '-', color = 'red')
mprop2 = dict(linestyle = '-',linewidth = 2, color = 'red')
pprop2 = dict(marker = 'o', markeredgecolor = 'red', markerfacecolor = 'red')
cap2 = dict(linewidth = 2, color = 'red')
...
bprop3 = dict(linewidth = 2, edgecolor = 'g')
wprop3 = dict(linewidth = 2, linestyle = '-', color = 'g')
mprop3 = dict(linestyle = '-',linewidth = 2, color = 'g')
pprop3 = dict(marker = 'o', markeredgecolor = 'g', markerfacecolor = 'g')
cap3 = dict(linewidth = 2, color = 'g')
...
bprop4 = dict(linewidth = 2, edgecolor = 'g', facecolor = 'lime')
