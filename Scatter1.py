...
#plot BA 
scat1.semilogy(WBZ[:,13],WBZ[:,0],'o',color='red',markersize=9, markeredgecolor = 'r')
scat1.semilogy(CBZ[:,13],CBZ[:,0],'o',color='white',markersize=9, markeredgecolor = 'r')
#plot N
scat1.semilogy(WN[:,13],WN[:,0],'o',color='g',markersize=9, markeredgecolor = 'g')
scat1.semilogy(CN[:,13],CN[:,0],'o',color='White',markersize=9, markeredgecolor = 'g')
#labels and limits
plt.ylim(0,400)
