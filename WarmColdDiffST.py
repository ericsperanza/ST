...
time1.set_ylabel('Total particle flux (mg/$\mathregular{cm^{2}/day}$)', size = 22, position = (1,0), **csfont)
...
time2.set_ylabel('Total sterols (mg/g)', size = 22, **csfont)
...
time4.set_ylabel("Total sterols (%sg/g)"%(u"\u03BC"), size = 22, **csfont)
